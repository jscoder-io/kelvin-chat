<div class="p-4">
    <h1 class="text-xl font-bold mb-4 pb-2 border-b">{{ __('Edit Shop') }}</h1>
    <form wire:submit.prevent="save">
        ...
        <div class="flex items-center mb-4">
            ...
            <div class="w-2/3 ">
                <select wire:model="form.marketplace" wire:change="$refresh" class="block mt-1 p-2 w-full text-sm bg-white border border-gray-300 focus-visible:outline-none focus:border-indigo-500 focus:ring-indigo-500 rounded shadow-sm" disabled>
